...
public class FileProvenanceFromAnalysisProvenance implements FileProvenance {
  ...
  public String toString() {
    return "FileProvenance{"
        ...
        + ", "
        + "parentSampleNames="
        + getParentSampleNames()
        + ", "
        + "parentSampleOrganismIDs="
        + getParentSampleOrganismIDs()
        + ", "
        + "parentSampleAttributes="
        + getParentSampleAttributes()
        + ", "
        + "sampleNames="
        + getSampleNames()
        + ", "
        + "sampleOrganismIDs="
        + getSampleOrganismIDs()
        + ", "
        + "sampleOrganismCodes="
        + getSampleOrganismCodes()
        + ", "
        + "sampleAttributes="
        + getSampleAttributes()
        + ", "
        + "sequencerRunNames="
        + getSequencerRunNames()
        + ", "
        + "sequencerRunAttributes="
        + getSequencerRunAttributes()
        + ", "
        + "sequencerRunPlatformIDs="
        + getSequencerRunPlatformIDs()
        + ", "
        + "sequencerRunPlatformNames="
        + getSequencerRunPlatformNames()
        + ", "
        + "laneNames="
        + getLaneNames()
        + ", "
        ...
        + ", "
        + "workflowRunInputFileSWIDs="
        + getWorkflowRunInputFileSWIDs()
        + ", "
        + "processingAlgorithm="
